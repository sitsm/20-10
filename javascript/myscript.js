...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "BẠN........ " ;
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;OOPS! Bạn đã vô tình kích hoạt...';
document.querySelector('.Description .modal-body').innerHTML = 'CHẾ ĐỘ SIÊU THÂN THIỆN TRONG NGÀY 20-10 <i class="fas fa-heart"></i> ';
